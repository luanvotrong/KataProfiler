...
namespace KataProfiler
{
	public class KPMipmapLevel
	{
		...
		public string FormatName
		{
			get
			{
				if (m_isCompressed == 1) return gl2.getString(m_format);

				switch (m_type)
				{
					case gl2.GL_UNSIGNED_SHORT_4_4_4_4:		return "RGBA 4444";
					case gl2.GL_UNSIGNED_SHORT_5_5_5_1:		return "RGBA 5551";
					case gl2.GL_UNSIGNED_SHORT_5_6_5:		return "RGB 565";

					case gl2.GL_UNSIGNED_BYTE:
					{
						if (m_format == gl2.GL_RGBA)		return "RGBA 8888";
						if (m_format == gl2.GL_RGB)			return "RGB 888";
						break;
					}
				}
