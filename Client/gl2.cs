...
namespace KataProfiler
{
	class gl2
	{
		...
		public static void init()
		{
			...
			//====================================================================================
			// EXT
			m_sDict.Add("PVRTC4_RGB", 0x8C00);
			m_sDict.Add("PVRTC2_RGB", 0x8C01);
			m_sDict.Add("PVRTC4_RGBA", 0x8C02);
			m_sDict.Add("PVRTC2_RGBA", 0x8C03);

			m_sDict.Add("ETC1_RGB8_OES", gl2.GL_ETC1_RGB8_OES);
			m_sDict.Add("ETC2_R11_EAC", gl2.GL_COMPRESSED_R11_EAC);
			m_sDict.Add("ETC2_SIGNED_R11_EAC", gl2.GL_COMPRESSED_SIGNED_R11_EAC);
			m_sDict.Add("ETC2_RG11_EAC", gl2.GL_COMPRESSED_RG11_EAC);
			m_sDict.Add("ETC2_SIGNED_RG11_EAC", gl2.GL_COMPRESSED_SIGNED_RG11_EAC);
			m_sDict.Add("ETC2_RGB8", gl2.GL_COMPRESSED_RGB8_ETC2);
			m_sDict.Add("ETC2_SRGB8", gl2.GL_COMPRESSED_SRGB8_ETC2);
			m_sDict.Add("ETC2_RGB8_PUNCHTHROUGH_ALPHA1", gl2.GL_COMPRESSED_RGB8_PUNCHTHROUGH_ALPHA1_ETC2);

			m_sDict.Add("ETC2_SRGB8_PUNCHTHROUGH_ALPHA1", gl2.GL_COMPRESSED_SRGB8_PUNCHTHROUGH_ALPHA1_ETC2);
			m_sDict.Add("ETC2_RGBA8_EAC", gl2.GL_COMPRESSED_RGBA8_ETC2_EAC);
			m_sDict.Add("ETC2_SRGB8_ALPHA8_EAC", gl2.GL_COMPRESSED_SRGB8_ALPHA8_ETC2_EAC);

			m_sDict.Add("DXT1_RGB", 0x83F0);
			m_sDict.Add("DXT1_RGBA", 0x83F1);
			m_sDict.Add("DXT3", 0x83F2);
			m_sDict.Add("DXT5", 0x83F3);

			//
			m_sDict.Add("GL_SAMPLER_3D", 0x8B5F);
		}
