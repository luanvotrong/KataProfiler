...
#define MAX_ATTRIBUTES_NUMBER	128
#define MAX_UNIFORMS_NUMBER		128
...
{
public:
	KPProgram() : KPGLObject(), m_vsId(0), m_fsId(0), m_attributesCount(0), m_uniformsCount(0) {}

	KPProgram(u32 id) : KPGLObject(id), m_vsId(0), m_fsId(0), m_attributesCount(0), m_uniformsCount(0) {}
